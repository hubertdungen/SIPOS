...
| Item | Estado |
| --- | --- |
| Marco beta visível actual | **Beta 1.3.0** |
| Tipo de aplicação | Aplicação desktop Windows Forms |
| Framework alvo | `net10.0-windows` |
...
- .NET SDK 10.x (ou SDK compatível) capaz de compilar projectos `net10.0-windows`.
