...
- asks for a version label, defaulting to `Beta-1.5.2`;
...
```powershell
powershell -ExecutionPolicy Bypass -File .\scripts\Publish-Portable.ps1 -Version Beta-1.5.2
```
...
```text
artifacts\SIPOS-Beta-1.5.2-win-x64-portable.zip
```
